      ...
      <div className="bg-haze minh-viewport flex flex-column">
        ...
        <div className="my-5 mx-auto container grow-1 justify">
          ...
          <p css={aboutText}>
            ...
            <a href="https://in.linkedin.com/company/facilio-inc">Facilio</a>,
            where I work on web apps. I mostly use JavaScript these days but I
            ocassionally also dabble in Python. I'm really interested in
            developer tooling and software infrastructure, and I occasionally
            write about all this on my blog.
          </p>
          <p css={aboutText} />
          <p css={aboutText}>
            Outside of tech, I'm a huge film nerd. You name it, I've seen it (or
            at least have a reason not to have). Besides films, I love traveling
            and adore spicy food.
          </p>
